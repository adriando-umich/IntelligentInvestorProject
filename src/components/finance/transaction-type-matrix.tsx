...
const businessRows: MatrixRow[] = [
  ...
  },
  {
    ...
    useWhen: "The project pays shared loan interest and the team shares that bank cost.",
    example: "Monthly bank interest on the project loan is paid from one member account and shared across members.",
    cashEffect: "Money goes out",
  ...
  },
  {
    ...
    example: "Legal, marketing, contractor, survey, utilities, or permit costs.",
    cashEffect: "Money goes out",
    reimbursementEffect: "Can create teammate debt",
    capitalEffect: "No",
    pnlEffect: "Operating P&L down",
